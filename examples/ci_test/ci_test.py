...
# FUNC
g = madupite.Matrix.fromFile(name="g", filename="100_50_0.1/g.bin", category=madupite.MatrixCategory.Cost, type=madupite.MatrixType.Dense)
P = madupite.Tensor.fromFile(name="P", filename="100_50_0.1/P.bin", category=madupite.MatrixCategory.Dynamics, type=madupite.MatrixType.Sparse)
