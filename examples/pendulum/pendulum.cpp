...
int main(int argc, char** argv)
{
    ...
    auto g_mat = Matrix::fromFile(comm, "g_file", "../examples/pendulum/data/pend_g_441_9.bin", MatrixCategory::Cost, MatrixType::Dense);
    auto P_mat = Matrix::fromFile(comm, "P_file", "../examples/pendulum/data/pend_P_441_9.bin", MatrixCategory::Dynamics);
